...
void process(String splitted[]){
  ...
  }else if (splitted[0].equals("12")){//window
    window1.process(splitted[1],splitted[2].toInt(),splitted[3].toInt(),splitted[4].toInt());
  }
}
